...
two rows do not show up in my graph. I am not sure what caused this, and when I played around with some of the 
code I failed to fix this. I also made some minor changes and adjustments on the environment-level, in 
